...
/**
 * @brief Return the block header associated with this entry.
 *
 * @param[in] block_tree_entry Non-null.
...
/**
 * @brief Processes and validates the passes in block header.
 *
 * @param[in] chainstate_manager  Non-null.
 * @param[in] header    Non-null header to be validated.
 * @param[out] block_validation_state  The result of the header validation.
 * @return              0 if header processing completed successfully, non-zero on error.
 */
...
/**
 * @brief Get the header from the block.
 *
...
/**
 * @brief Get the previous block hash from block header.
 *
 * @param[in] header    Non-null header
...
/**
 * @brief Get the timestamp from block header.
 *
 * @param[in] header    Non-null header
...
/**
 * @brief Get the nBits difficulty target from block header.
 *
 * @param[in] header    Non-null header
...
/**
 * @brief Get the version from block header.
 *
 * @param[in] header    Non-null header
